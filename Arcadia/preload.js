...
contextBridge.exposeInMainWorld('electron', {
  ...
  // Send script to Opiumware across its local TCP ports
  sendToOpiumware: (script, port = 'ALL') => ipcRenderer.invoke('send-to-opiumware', script, port),
  // (openLocalServer removed)
  checkHydrogen: () => ipcRenderer.invoke('check-hydrogen'),
  checkMacsploit: () => ipcRenderer.invoke('check-macsploit'),
  checkOpiumware: () => ipcRenderer.invoke('check-opiumware'),
